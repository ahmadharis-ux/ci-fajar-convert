    ...
    <div class="d-flex justify-content-center">
        <div class="edit-page-pengaturan mx-3 px-2 mx-auto pt-1">
            ...
            <div class="row-edit-pengaturan">
                <div class="label-edit-pengaturan">
                    <label for="">Email</label>
                </div>
                <input class="input-edit-pengaturan" type="email" value="ahmadHaris@gmail.com">
            </div>
            <!-- nama -->
            <div class="row-edit-pengaturan">
                <div class="label-edit-pengaturan">
                ...
                <input class="input-edit-pengaturan" type="text" value="Ahmad Haris">
            </div>
            <!-- no hp -->
            <div class="row-edit-pengaturan">
                <div class="label-edit-pengaturan">
                ...
                <input class="input-edit-pengaturan" type="number" value="085156511121">
            </div>
        </div>
    </div>
